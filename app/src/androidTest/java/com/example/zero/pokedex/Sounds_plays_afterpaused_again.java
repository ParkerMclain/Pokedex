...
public class Sounds_plays_afterpaused_again {

    @Rule
    public ActivityTestRule<Welcome> mActivityTestRule = new ActivityTestRule<>(Welcome.class);

    @Test
    public void sounds_plays_afterpaused_again() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.emailText2), withText("t"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                0),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("test786@yahoo.com"));

        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.emailText2), withText("test786@yahoo.com"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.emailText2), withText("test786@yahoo.com"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("test@yahoo.com"));
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.passwordText2),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("test786"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatButton5 = onView(
                allOf(withId(R.id.songPP), withText("Play/Pause Song"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
