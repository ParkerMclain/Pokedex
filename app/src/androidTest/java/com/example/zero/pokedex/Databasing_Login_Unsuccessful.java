        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.emailText2), withText("te"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("test@test.com"));

        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.emailText2), withText("test@test.com"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.passwordText2),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("test4321"), closeSoftKeyboard());
