        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.emailText2), withText("te"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("test@yahoo.com"));
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.passwordText2),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("test786"), closeSoftKeyboard());
